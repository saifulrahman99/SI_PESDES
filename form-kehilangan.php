		...
		<div id="konten">
			...
			<div class="isi-konten m-3">
				<div class="container">
					...
					<h4 class="fw-bolder">Form Surat Keterangan Kehilangan</h4>
					<div class="wrap shadow-sm p-3">
						<!-- form temukan NIK -->
						<form action="cari/cari-cetak.php?jenis=kehilangan" method="POST">
					...
					<div class="wrap shadow-sm p-3 mt-3">
						<form action="cetak/cetak-kehilangan.php" method="POST">
							<div class="row ps-3">
								<!-- kiri -->
								...
								<div class="col-6">
									...
									<div class="form-group mb-1 d-flex align-items-center">
										...
										<textarea class="form-control bg-light" id="keterangan" name="keterangan" placeholder="Tersebut diatas benar-benar telah kehilangan xxx"></textarea>
									</div>
									...
									<div class="form-group mb-1 d-flex align-items-center">
										...
										<textarea class="form-control bg-light" id="keperluan" name="keperluan" placeholder="Cetak Kartu Keluarga baru atau lain nya"></textarea>
									</div>
