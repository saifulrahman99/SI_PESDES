...
$pdf->SetFont('Times','B',12);
$pdf->Ln(5);
$pdf->Cell(0,0,"Nomor: 401/$no_surat/431.513.9.2/$tahun",0,1,'C');
// isi
$pdf->Ln(10);
$pdf->Cell(5);
...
$pdf->Cell(13);
$pdf->SetFont('Times','',12);
$pdf->Cell(0,7,'Tersebut di atas adalah benar-benar warga penduduk desa Bantal, kecamatan Asembagus, ',0,1,'L');
$pdf->Cell(0,7,' kabupaten Situbondo dan yang bersangkutan di atas adalah dari keluarga tidak mampu.',0,1,'L');

$pdf->Cell(13);
$pdf->SetFont('Times','',12);
$pdf->Cell(0,7,'Surat  keterangan   ini  dibuat   dengan  sebenarnya  dan  untuk   digunakan  sebagaimana',0,1,'L');
$pdf->Cell(1);
