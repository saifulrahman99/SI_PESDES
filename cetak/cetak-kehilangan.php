...
$pdf->Cell(13);
$pdf->SetFont('Times','',12);
$pdf->Cell(0,7,'Demikian keterangan ini kami buat untuk menjadikan periksa dan harap maklum adanya.',0,1,'L');
