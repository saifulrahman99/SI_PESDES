...
<head>
	...
	<title>Cetak Surat Keterangan Lokasi Tanah</title>
	<?php 
		...
		<div id="konten">
			...
			<div class="isi-konten m-3">
				<div class="container">
					...
					<h4 class="fw-bolder">Form Surat Keterangan Lokasi Tanah</h4>
					<div class="wrap shadow-sm p-3">
						<!-- form temukan NIK -->
						<form action="cari/cari-cetak.php?jenis=lokasi-tanah" method="POST">
					...
					<div class="wrap shadow-sm p-3 mt-3">
						<form action="cetak/cetak-lokasi-tanah.php" method="POST">
							<div class="row ps-3">
								<!-- kiri -->
								...
								<div class="col-6">
									...
									<div class="form-group mb-1 d-flex align-items-center">
										<label for="luas" class="mb-2 col-3 pt-2 pb-2">Luas Tanah</label>

										<input name="luas" id="luas"  class="form-control bg-light" type="text" placeholder="Masukkan Luas Tanah Garapan" required>
									</div>
