		...
		<div id="konten">
			...
			<div class="isi-konten m-3">
				<div class="container">
					...
					<h4 class="fw-bolder">Form Surat Keterangan Kelakuan Baik / Surat Keterangan Catatan Kepolisian</h4>
					<div class="wrap shadow-sm p-3">
						<!-- form temukan NIK -->
						<form action="cari/cari-cetak.php?jenis=skkb" method="POST">
					...
					<div class="wrap shadow-sm p-3 mt-3">
						<form action="cetak/cetak-skkb.php" method="POST">
							<div class="row ps-3">
								<!-- kiri -->
								...
								<div class="col-6">
									...
									<div class="form-group mb-1 d-flex align-items-center">
										...
										<textarea class="form-control bg-light" id="keperluan" name="keperluan" placeholder="Persyaratan melamar pekerjaan atau lain nya"></textarea>
									</div>
