...
<head>
	...
	<title>Cetak Kepemilikan Tanah</title>
	<?php 
		...
		<div id="konten">
			...
			<div class="isi-konten m-3">
				<div class="container">
					...
					<h4 class="fw-bolder">Form Surat Keterangan Kepemilikan Tanah</h4>
					<div class="wrap shadow-sm p-3">
						<!-- form temukan NIK -->
						<form action="cari/cari-cetak.php?jenis=kepemilikan" method="POST">
					...
					<div class="wrap shadow-sm p-3 mt-3">
						<form action="cetak/cetak-kepemilikan-tanah.php" method="POST">
							<div class="row ps-3">
								<!-- kiri -->
								...
								<div class="col-6">
									...
									<div class="form-group mb-1 d-flex align-items-center">
										...
										<input name="ket_wn" id="ket_wn"  class="form-control bg-light" type="text" value="Indonesia" required>
									</div>
									...
									<div class="form-group mb-1 d-flex align-items-center">
										...
										<input name="no_sertifikat" id="no_sertifikat"  class="form-control bg-light" type="text" required>
									</div>

									<div class="form-group mb-1 d-flex align-items-center">
										<label for="sppt" class="mb-2 col-3 pt-2 pb-2 me-4">Nomor SPPT</label>

										<input name="sppt" id="sppt"  class="form-control bg-light" type="text">
									</div>

									<div class="form-group mb-1 d-flex align-items-center">
										<label for="luas" class="mb-2 col-3 pt-2 pb-2 me-4">Luas Tanah</label>
									...
									<div class="form-group mb-1 d-flex align-items-center">
										...
										<select id="f_surat" class="form-control bg-light" name="f_surat" required>
											...
											<option value="fdesa">FORMAT DESA</option>
											<option value="fbank">FORMAT BANK</option>
