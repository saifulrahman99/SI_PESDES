...
if (isset($_POST['tujuan'])) {
	...
	echo "kesalahan dari tujuan";
}
// batas
if (isset($_POST['kodeSurat'])) {
	$kodeSurat = $_POST['kodeSurat'];
}
else{
	echo "kesalahan dari kodeSurat";
}
...
$pdf->Line(77,58.9,144,58.9);

$pdf->SetFont('Times','B',12);
$pdf->Ln(5);
$pdf->Cell(0,0,"Nomor: $kodeSurat/$no_surat/431.513.9.2/$tahun",0,1,'C');
// isi
$pdf->Ln(10);
$pdf->Cell(5);
...
$pdf->Cell(8);
$pdf->Cell(40,7,'Alamat yang dituju',0,0,'L');
$pdf->Cell(5,7,':',0,0,'L');
$pdf->MultiCell(0,7,"$tujuan.",0,'L');
...
$pdf->Cell(10);
$pdf->SetFont('Times','',12);
$pdf->Cell(0,7,'Demikian surat keterangan ini dibuat dengan sebenarnya dan untuk digunakan sebagaimana',0,1,'L');
$pdf->Cell(1);
