...
<head>
	...
	<title>Cetak Ket Perjalanan</title>
	<?php 
		...
		<div id="konten">
			...
			<div class="isi-konten m-3">
				<div class="container">
					...
					<h4 class="fw-bolder">Form Surat Keterangan Jalan (Bepergian)</h4>
					<div class="wrap shadow-sm p-3">
						<!-- form temukan NIK -->
						<form action="cari/cari-cetak.php?jenis=jalan" method="POST">
					...
					<div class="wrap shadow-sm p-3 mt-3">
						<form action="cetak/cetak-jalan.php" method="POST">
							<div class="row ps-3">
								<!-- kiri -->
								...
								<div class="col-6">
									...
									<div class="form-group mb-1 d-flex align-items-center">
										<label for="perkawinan" class="col-3 pt-2 pb-2 me-4">Perkawinan</label>
									...
									<div class="form-group mb-1 d-flex align-items-center">
										<label for="kodeSurat" class="col-3 pt-2 pb-2 me-4">Jenis Keterangan</label>

										<select id="kodeSurat" class="form-control bg-light" name="kodeSurat" required>
											<option value="">- Pilih</option>
											<option value="511.2">IZIN ANGKUTAN BARANG</option>
											<option value="511.21">IZIN ORANG BEPERGIAN</option>
									...
									<div class="form-group mb-1 d-flex align-items-center">
										...
										<label for="tujuan" class="mb-2 col-3 pt-4 pb-4 me-4">Alamat yang dituju</label>

										<textarea class="form-control bg-light" id="tujuan" name="tujuan" placeholder=""></textarea>
									</div>
									...
									<div class="form-group mb-1 d-flex align-items-center">
										...
										<textarea class="form-control bg-light" id="keperluan" name="keperluan" placeholder=""></textarea>
									</div>
