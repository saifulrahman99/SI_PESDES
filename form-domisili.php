...
<head>
	...
	<title>Cetak Domisili Baru</title>
	<?php 
		...
		<div id="konten">
			...
			<div class="isi-konten m-3">
				<div class="container">
					...
					<h4 class="fw-bolder">Form Surat Keterangan Domisili Baru</h4>
					<div class="wrap shadow-sm p-3">
						<!-- form temukan NIK -->
						<form action="cari/cari-cetak.php?jenis=domisili" method="POST">
					...
					<div class="wrap shadow-sm p-3 mt-3">
						<form action="cetak/cetak-domisili.php" method="POST">
							<div class="row ps-3">
								<!-- kiri -->
