...
// batas
if (isset($_POST['nama_kp'])) {
	$nama_kp = $_POST['nama_kp'];
}
else{
	echo "kesalahan dari nama_kp";
}
// batas
...
$pdf->Ln(9);
$pdf->Cell(109);
$pdf->Cell(60,2,"Bantal, $hari $bulan $tahun",0,1,'C');
$pdf->Cell(16,5,"Nomor",0,0,'L');
$pdf->Cell(2);
$pdf->Cell(5,5,':',0,0,'L');
$pdf->Cell(0,5,"470/$no_surat/431.502.9.10/2022",0,1,'L');

$pdf->Cell(16,5,'Sifat',0,0,'L');
$pdf->Cell(2);
$pdf->Cell(5,5,':',0,0,'L');
$pdf->Cell(86,5,"Penting",0,0,'L');
$pdf->Cell(0,5,"Kepada :",0,1,'C');

$pdf->Cell(16,5,'Lampiran',0,0,'L');
$pdf->Cell(2);
$pdf->Cell(5,5,':',0,0,'L');
$pdf->Cell(83.5,5,"1 Berkas",0,0,'L');
...
$pdf->Cell(84,5,"Permohonan Pembuatan KK",0,0,'L');
$pdf->SetFont('Times','',12);
...
$pdf->Cell(12.5);
$pdf->Cell(43,7,'Tempat, tgl.Lahir',0,0,'L');
$pdf->Cell(5,7,':',0,0,'L');
$pdf->Cell(0,7,"$tmpt_lahir, $ttl_new",0,1,'L');

$pdf->Cell(12.5);
$pdf->Cell(43,7,'Pekerjaan',0,0,'L');
$pdf->Cell(5,7,':',0,0,'L');
$pdf->Cell(0,7,$pekerjaan,0,1,'L');

$pdf->Cell(12.5);
$pdf->Cell(43,7,'Nama Kepala Keluarga',0,0,'L');
$pdf->Cell(5,7,':',0,0,'L');
$pdf->SetFont('Times','B',12);
$pdf->Cell(0,7,$nama_kp,0,1,'L');

$pdf->Cell(12.5);
$pdf->SetFont('Times','',12);
$pdf->Cell(43,7,'Kartu Keluarga Nomor',0,0,'L');
$pdf->Cell(5,7,':',0,0,'L');
